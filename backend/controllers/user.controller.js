...
export const followUnfollowUser = async (req,res) =>{
    ...
    try {
        ...
        console.log("Error in user Controller function ,:" , error.message);
        res.status(500).json({ error : error.message});
    }
}
...
export const getSuggestedUsers = async (req,res) => {
    ...
    try {
        ...
        const usersFollowerdByMe = await User.findById(userId).select("following");
        ...
        const filteredUsers = users.filter(user => !usersFollowerdByMe.following.includes(user._id));
        ...
        console.log("error in user controller get Suggested function : " , error.message);
        res.status(500).json({ error : error.message});
    }
}
